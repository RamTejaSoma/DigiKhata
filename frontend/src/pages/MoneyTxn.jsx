...
const MoneyTxn = () => {
  ...
  const fetchTransactions = async () => {
    try {
      const { data } = await axios.get(`${backendUrl}/api/moneyTransaction/all`, {
  ...
  const deleteTransaction = async (id) => {
   ...
   const submitFilter_report = async (e) => {
    ...
    try {
      ...
      a.href = url;
      a.download = "MoneyTxn_expenses_report.pdf"; //downloading
  ...
  return <div>
     <div className="flex   text-xs sm:text-base justify-center gap-4 bg-gradient-to-r from-violet-100 via-violet-50 to-violet-100 p-1 sm:p-2 rounded-xl shadow-md mt-1 sm:mt-2 ">
        ...
        <button
          onClick={() => navigate("/moneyTransaction/add")}
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            >
              ...
              <label className="flex flex-col text-gray-700 font-medium">
                ...
                >
                  <option value={"All"}>All</option>
                  <option value={"given"}>Spent</option>
            ...
            transactions.map((txn, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-2 items-center">
                  <div
                    className={`font-bold ${
                      txn.transactionType === "given" ? "text-red-600" : "text-green-600"
                    }`}
                  >
